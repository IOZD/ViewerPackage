...
const TlogDocsService = (function () {
    ...
    //Create the Buttons
    function orderTypesListCreator(tlog, billData) {
    ...
    function getDocs(tlog, billData) {
        let docsArray;
        ...
        docsArray = orderTypesListCreator(tlog, _enrichPrintData);
    ...
    TlogDocsService.prototype.getDocs = (tlog, billData) => getDocs(tlog, billData);
