...
let TemplateBuilderService = (function () {
    ...
    function createDocTemplate(docTypeChosen, billData) {
        ...
        if (isCreditSlip !== null && isCreditSlip) {
            ...
            tplOrderPaymentData.hasChildNodes() ? tplOrderPaymentData.classList += ' body-div tpl-body-div' : '';
            ...
            docTemplate.appendChild(tplOrderTotals);
            docTemplate.appendChild(tplOrderPayments);
    ...
    function createHeader(printData) {
        ...
        tplHeaderConstants.class = 'tplHeaderConstants';
        // setting constants
        let headerKeys = [
            'ORGANIZATION_NAME',
        ...
        switch (htmlElement.id) {
            ...
            case 'tplOrderType': {
                if (printData.variables.ORDER_TYPE) {
                    ...
                    htmlElement.innerHTML = "<span style='display:flex; flex-direction: flex-start'>" + typeTranslate + " " + typeDataTranslate + "</span>" + " #" + printData.variables.ORDER_NO
                    htmlElement.setAttribute('class', 'med-chars');
    ...
    function createDeliveryNoteTransactionData(printData) {
        ...
        if (printData.isRefund === true) {
            ...
            deliveryNoteTransactionDiv.appendChild(refundTextDiv);
        ...
        if (hAccountPayments) {
            ...
            if (hAccountPayments.P_CHANGE > 0) {
                ...
                deliveryNoteTransactionDiv.appendChild(cashBackDiv);
            }
            ...
            if (hAccountPayments.PROVIDER_TRANS_ID) {
                ...
                deliveryNoteTransactionDiv.appendChild(providerTransDiv);
            }
            ...
            if (hAccountPayments.CHARGE_ACCOUNT_NAME) {
                ...
                deliveryNoteTransactionDiv.appendChild(cAccountNameDiv);
            }
            ...
            if (hAccountPayments.COMPANY_NAME) {
                ...
                deliveryNoteTransactionDiv.appendChild(companyNameDiv);
            }
            ...
            if (hAccountPayments.LAST_4) {
                ...
                deliveryNoteTransactionDiv.appendChild(lastFourDiv);
            }
            ...
            if (hAccountPayments.PROVIDER_PAYMENT_DATE) {
                ...
                deliveryNoteTransactionDiv.appendChild(transactionTimeDiv);
    ...
    function createPaymentsData(printData) {
        ...
        tplOrderPaymentsDiv.classList.add('body-div');
    ...
    function createCreditSlip(_printData, docTypeChosen) {
        ...
        if (creditSlipDoc) {
            ...
            if (docTypeChosen.md.signature) {
                ...
                var svgString = `<svg id='svg' width='100%' height='100' transform='translate(0, 0)' viewBox="0 0 500 300"></svg>`
                ...
                elementSVGDiv.setAttribute("width", "100%");
                ...
                var path = makeSVG('path', { d: signatureData, stroke: "#06067f", 'stroke-width': "2", transform: 'translate(50,-80) scale(0.5,0.5)', 'stroke-linecap': "butt", fill: "none", 'stroke-linejoin': "miter" });
